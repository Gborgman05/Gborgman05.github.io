...
export class HorrorComponent {
  ...
  { category: 'Movie', name: 'The Conjuring', link: 'https://www.imdb.com/title/tt1457767/' },
  { category: 'TV Series', name: 'American Horror Story: 1984', link: 'https://en.wikipedia.org/wiki/American_Horror_Story:_1984' },
]
